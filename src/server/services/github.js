...
function callGithub(github, obj, fun, arg, token, done) {
    ...
    github[obj][fun](arg, function (err, res) {
        ...
        logger.info({ name: 'CLAAssistantGithubCall', obj: obj, fun: fun, arg: createLogObj(arg), token: hashToken(token), remaining: res && res.meta ? res.meta['x-ratelimit-remaining'] : '', err });
